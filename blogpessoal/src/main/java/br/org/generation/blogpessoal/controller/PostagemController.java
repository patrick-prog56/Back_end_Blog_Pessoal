...
@CrossOrigin(origins = "*", allowedHeaders = "*") // sem isso o front end não funciona muito bem = diz que essa classe vai aceitar requisiÃ§Ãµes de qualquer origem do front end, como react e etc.
